...
public class BackgroundScrolling : MonoBehaviour
{
    ...
    void Update()
    {
        float boosterMaxTime = GameObject.FindGameObjectsWithTag("Player")[0].transform.GetComponent<ShootingScript>().speedBoosterMaxTime;
        float boosterTimer = Mathf.Max(GameObject.FindGameObjectsWithTag("Player")[0].transform.GetComponent<ShootingScript>().speedBoosterTimer, 0);
